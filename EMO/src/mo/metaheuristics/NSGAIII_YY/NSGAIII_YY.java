package mo.metaheuristics.NSGAIII_YY;
...
import mo.util.Niching;
import mo.util.Ranking.NDSRanking;
import mo.util.vector.TwoLevelWeightVectorGenerator;
import mo.util.vector.VectorGenerator;

public class NSGAIII_YY extends Algorithm {
	...
	public NSGAIII_YY(Problem problem) {
		super(problem);
	} // NSGAII
