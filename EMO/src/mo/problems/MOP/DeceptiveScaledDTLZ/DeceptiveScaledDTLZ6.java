 ...
 */
public class DeceptiveScaledDTLZ6 extends Problem{
  ...
  */
  public DeceptiveScaledDTLZ6(String solutionType) throws ClassNotFoundException {
    this(12, 3);
  }
  public DeceptiveScaledDTLZ6(HashMap<String, Object> parameters) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public DeceptiveScaledDTLZ6( int numberOfVariables, int numberOfObjectives) {
    numberOfVariables_  = numberOfVariables;
    numberOfObjectives_ = numberOfObjectives;
    problemName_        = "DeceptiveScaledDTLZ6";
