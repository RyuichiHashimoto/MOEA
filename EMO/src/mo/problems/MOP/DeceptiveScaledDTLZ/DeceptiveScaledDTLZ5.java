 ...
 */
public class DeceptiveScaledDTLZ5 extends Problem{
  ...
  */
  public DeceptiveScaledDTLZ5(String solutionType) throws ClassNotFoundException {
    this(12, 3);
  }
  public DeceptiveScaledDTLZ5(HashMap<String, Object> parameters) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public DeceptiveScaledDTLZ5( int numberOfVariables, int numberOfObjectives) {
    numberOfVariables_  = numberOfVariables;
    numberOfObjectives_ = numberOfObjectives;
    problemName_        = "DeceptiveScaledDTLZ5";
