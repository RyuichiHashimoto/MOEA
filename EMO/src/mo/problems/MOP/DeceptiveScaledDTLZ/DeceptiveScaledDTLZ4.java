 ...
 */
public class DeceptiveScaledDTLZ4 extends Problem{
  ...
  */
  public DeceptiveScaledDTLZ4(String solutionType) throws ClassNotFoundException {
    this(12, 3);
  }
  public DeceptiveScaledDTLZ4(HashMap<String, Object> parameters) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public DeceptiveScaledDTLZ4( int numberOfVariables, int numberOfObjectives) {
    numberOfVariables_  = numberOfVariables;
    numberOfObjectives_ = numberOfObjectives;
    problemName_        = "DeceptiveScaledDTLZ4";
