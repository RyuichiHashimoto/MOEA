 ...
 */
public class DeceptiveScaledDTLZ7 extends Problem{
  ...
  */
  public DeceptiveScaledDTLZ7(String solutionType) throws ClassNotFoundException {
    this(12, 3);
  }
  public DeceptiveScaledDTLZ7(HashMap<String, Object> parameters) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public DeceptiveScaledDTLZ7( int numberOfVariables, int numberOfObjectives) {
    numberOfVariables_  = numberOfVariables;
    numberOfObjectives_ = numberOfObjectives;
    problemName_        = "DeceptiveScaledDTLZ7";
