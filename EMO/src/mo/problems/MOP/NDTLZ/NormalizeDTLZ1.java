 ...
 */
public class NormalizeDTLZ1 extends Problem {
 /**
  * Creates a default DTLZ1 problem (7 variables and 3 objectives)
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public NormalizeDTLZ1(String solutionType) throws ClassNotFoundException {
    this(7, 3);
  } // DTLZ1

	public NormalizeDTLZ1(HashMap<String, Object> parameters) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public NormalizeDTLZ1(  int  numberOfVariables,  int  numberOfObjectives) {
	numberOfVariables_  = numberOfVariables;
    numberOfObjectives_ = numberOfObjectives;
    problemName_        = "NormalizeDTLZ1";
