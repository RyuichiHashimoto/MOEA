 ...
 */
public class ScaledDTLZ6 extends Problem{
  ...
  */
  public ScaledDTLZ6(String solutionType) throws ClassNotFoundException {
    this(12, 3);
  }
  public ScaledDTLZ6(HashMap<String, Object> parameters) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public ScaledDTLZ6( int numberOfVariables, int numberOfObjectives) {
    numberOfVariables_  = numberOfVariables;
    numberOfObjectives_ = numberOfObjectives;
    problemName_        = "ScaledDTLZ6";
