 ...
 */
public class ScaledDTLZ7 extends Problem{
  ...
  */
  public ScaledDTLZ7(String solutionType) throws ClassNotFoundException {
    this(12, 3);
  }
  public ScaledDTLZ7(HashMap<String, Object> parameters) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public ScaledDTLZ7( int numberOfVariables, int numberOfObjectives) {
    numberOfVariables_  = numberOfVariables;
    numberOfObjectives_ = numberOfObjectives;
    problemName_        = "ScaledDTLZ7";
