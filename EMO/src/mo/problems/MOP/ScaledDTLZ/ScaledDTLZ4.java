 ...
 */
public class ScaledDTLZ4 extends Problem{
  ...
  */
  public ScaledDTLZ4(String solutionType) throws ClassNotFoundException {
    this(12, 3);
  }
  public ScaledDTLZ4(HashMap<String, Object> parameters) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public ScaledDTLZ4( int numberOfVariables, int numberOfObjectives) {
    numberOfVariables_  = numberOfVariables;
    numberOfObjectives_ = numberOfObjectives;
    problemName_        = "ScaledDTLZ4";
