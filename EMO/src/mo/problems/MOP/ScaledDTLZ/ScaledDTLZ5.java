 ...
 */
public class ScaledDTLZ5 extends Problem{
  ...
  */
  public ScaledDTLZ5(String solutionType) throws ClassNotFoundException {
    this(12, 3);
  }
  public ScaledDTLZ5(HashMap<String, Object> parameters) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public ScaledDTLZ5( int numberOfVariables, int numberOfObjectives) {
    numberOfVariables_  = numberOfVariables;
    numberOfObjectives_ = numberOfObjectives;
    problemName_        = "ScaledDTLZ5";
