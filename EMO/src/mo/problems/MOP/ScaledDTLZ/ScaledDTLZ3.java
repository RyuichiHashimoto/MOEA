 ...
 */
public class ScaledDTLZ3 extends Problem{

 /**
  * Creates a default DTLZ3 problem (12 variables and 3 objectives)
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public ScaledDTLZ3(String solutionType) throws ClassNotFoundException {
    this(12, 3);
  } // DTLZ3
  public ScaledDTLZ3(HashMap<String, Object> parameters) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public ScaledDTLZ3(int numberOfVariables, int numberOfObjectives) {
    numberOfVariables_   = numberOfVariables;
    numberOfObjectives_  = numberOfObjectives;
    problemName_         = "ScaledDTLZ3";
