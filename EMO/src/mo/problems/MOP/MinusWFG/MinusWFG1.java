 ...
 */
public class MinusWFG1 extends WFG {
  ...
  */
  public MinusWFG1(String solutionType) throws ClassNotFoundException {
    this(2, 4, 2) ;
  } // WFG1
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public MinusWFG1( Integer k, Integer l, Integer M) throws ClassNotFoundException {
    super(k,l,M);
    problemName_ = "MinusWFG1";
