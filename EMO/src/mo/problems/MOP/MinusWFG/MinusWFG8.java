...
* and 2 objectives
*/
public class MinusWFG8 extends WFG{
  ...
  */
  public MinusWFG8(String solutionType) throws ClassNotFoundException {
    this(2, 4, 2) ;
  } // WFG8
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public MinusWFG8 ( Integer k, Integer l, Integer M) throws ClassNotFoundException {
    super( k,l,M);
    problemName_ = "MinusWFG8";
  ...
  */
  public double [] evaluate(double [] z){
	...
	public MinusWFG8(HashMap<String, Object> parameters) throws ClassNotFoundException {
