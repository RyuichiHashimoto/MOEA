 ...
 */
public class MinusWFG4 extends WFG{
  ...
  */
  public MinusWFG4(String solutionType) throws ClassNotFoundException {
    this( 2, 4, 2) ;
  } // WFG4
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public MinusWFG4 ( Integer k, Integer l, Integer M) throws ClassNotFoundException {
    super( k,l,M);
    problemName_ = "MinusWFG4";
  ...
  */
  public double [] t2(double [] z, int k, int M){
	...
	public MinusWFG4(HashMap<String, Object> parameters) throws ClassNotFoundException {
