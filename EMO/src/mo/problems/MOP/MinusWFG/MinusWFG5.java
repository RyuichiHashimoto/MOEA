 ...
 */
public class MinusWFG5 extends WFG{
  /**
  ...
  */
  public MinusWFG5(String solutionType) throws ClassNotFoundException {
    this( 2, 4, 2) ;
  } // WFG5
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public MinusWFG5(HashMap<String, Object> parameters) throws ClassNotFoundException {
		this( (Integer) parameters.get("K"),   (Integer) parameters.get("I"),(Integer) parameters.get("M"));
	}

  public MinusWFG5 (Integer k, Integer l, Integer M) throws ClassNotFoundException {
    super( k,l,M);
    problemName_ = "MinusWFG5";
