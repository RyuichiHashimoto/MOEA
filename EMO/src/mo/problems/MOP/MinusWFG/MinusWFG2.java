 ...
 */
public class MinusWFG2 extends WFG{
  ...
  */
  public MinusWFG2(String solutionType) throws ClassNotFoundException {
    this( 2, 4, 2) ;
  } // WFG2
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public MinusWFG2(Integer k, Integer l, Integer M) throws ClassNotFoundException {
    super( k,l,M);
    problemName_ = "MinusWFG2";
	...
	public MinusWFG2(HashMap<String, Object> parameters) throws ClassNotFoundException {
