...
* and 2 objectives
*/
public class MinusWFG9 extends WFG{
  ...
  */
  public MinusWFG9(String solutionType) throws ClassNotFoundException {
    this( 2, 4, 2) ;
  } // WFG9
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public MinusWFG9 ( Integer k, Integer l, Integer M) throws ClassNotFoundException {
    super( k,l,M);
    problemName_ = "MinusWFG9";
  ...
  */
  public double [] evaluate(double [] z){
	...
	public MinusWFG9(HashMap<String, Object> parameters) throws ClassNotFoundException {
