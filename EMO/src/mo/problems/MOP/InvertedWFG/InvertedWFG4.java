 ...
 */
public class InvertedWFG4 extends WFG{
  ...
  */
  public InvertedWFG4(String solutionType) throws ClassNotFoundException {
    this( 2, 4, 2) ;
  } // WFG4
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public InvertedWFG4 ( Integer k, Integer l, Integer M) throws ClassNotFoundException {
    super( k,l,M);
    problemName_ = "InvertedWFG4";
  ...
  */
  ...
  public double [] t1(double [] z, int k){
    ...
    for (int i = 0; i < z.length; i++) {
      result[i] = (new Transformations()).s_multi(z[i],30,10,(double)0.35);
    }
  ...
  */
  public double [] t2(double [] z, int k, int M){
	...
	public InvertedWFG4(HashMap<String, Object> parameters) throws ClassNotFoundException {
