...
* and 2 objectives
*/
public class InvertedWFG8 extends WFG{
  ...
  */
  public InvertedWFG8(String solutionType) throws ClassNotFoundException {
    this(2, 4, 2) ;
  } // WFG8
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public InvertedWFG8 ( Integer k, Integer l, Integer M) throws ClassNotFoundException {
    super( k,l,M);
    problemName_ = "InvertedWFG8";
  ...
  */
  public double [] evaluate(double [] z){
	...
	public InvertedWFG8(HashMap<String, Object> parameters) throws ClassNotFoundException {
  ...
  public double [] t1(double [] z, int k){
    ...
    for (int i = k; i < z.length; i++){
      ...
      result[i] = (new Transformations()).b_param(z[i],aux,(double)0.98/(double)49.98,(double)0.02,50);
    }
