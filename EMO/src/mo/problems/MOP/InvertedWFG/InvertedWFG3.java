 ...
 */
public class InvertedWFG3 extends WFG{
   ...
   */
  public InvertedWFG3(String solutionType) throws ClassNotFoundException {
    this(2, 4, 2) ;
  } // WFG3
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public InvertedWFG3 (Integer k, Integer l, Integer M) throws ClassNotFoundException {
    super(k,l,M);
    problemName_ = "InvertedWFG3";
	...
	public InvertedWFG3(HashMap<String, Object> parameters) throws ClassNotFoundException {
