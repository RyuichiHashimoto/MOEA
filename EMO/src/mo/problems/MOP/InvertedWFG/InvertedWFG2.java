 ...
 */
public class InvertedWFG2 extends WFG{
  ...
  */
  public InvertedWFG2(String solutionType) throws ClassNotFoundException {
    this( 2, 4, 2) ;
  } // WFG2
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public InvertedWFG2(Integer k, Integer l, Integer M) throws ClassNotFoundException {
    super( k,l,M);
    problemName_ = "InvertedWFG2";
	...
	public InvertedWFG2(HashMap<String, Object> parameters) throws ClassNotFoundException {
  ...
  */
  public double [] evaluate(double [] z){
    ...
    result[M_-1] = D_*x[M_-1] + S_[M_-1] * (new Shapes()).disc(x,5,(double)1.0,(double)1.0);
