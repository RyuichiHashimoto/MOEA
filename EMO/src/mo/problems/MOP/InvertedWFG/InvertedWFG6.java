 ...
 */
public class InvertedWFG6 extends WFG{
  ...
  */
  public InvertedWFG6(String solutionType) throws ClassNotFoundException {
    this( 2, 4, 2) ;
  } // WFG6
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public InvertedWFG6 ( Integer k, Integer l, Integer M) throws ClassNotFoundException {
    super(k,l,M);
    problemName_ = "InvertedWFG6";
	...
	public InvertedWFG6(HashMap<String, Object> parameters) throws ClassNotFoundException {
