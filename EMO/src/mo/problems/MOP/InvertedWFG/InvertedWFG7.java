...
import mo.util.JMException;
  ...
  */
public class InvertedWFG7 extends WFG{

  public InvertedWFG7(String solutionType) throws ClassNotFoundException {
    this( 2, 4, 2) ;
  } // WFG7
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
	public InvertedWFG7(HashMap<String, Object> parameters) throws ClassNotFoundException {
		this( (Integer) parameters.get("K"),   (Integer) parameters.get("I"),(Integer) parameters.get("M"));
	}

  public InvertedWFG7 ( Integer k, Integer l, Integer M) throws ClassNotFoundException {
    super( k,l,M);
    problemName_ = "InvertedWFG7";
