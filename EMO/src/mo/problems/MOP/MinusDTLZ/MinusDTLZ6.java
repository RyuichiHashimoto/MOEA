 ...
 */
public class MinusDTLZ6 extends Problem{
  ...
  */
  public MinusDTLZ6(String solutionType) throws ClassNotFoundException {
    this(12, 3);
  }
  public MinusDTLZ6(HashMap<String, Object> parameters) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public MinusDTLZ6( int numberOfVariables, int numberOfObjectives) {
    numberOfVariables_  = numberOfVariables;
    numberOfObjectives_ = numberOfObjectives;
    problemName_        = "MinusDTLZ6";
