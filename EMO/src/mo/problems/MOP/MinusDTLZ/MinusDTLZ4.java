 ...
 */
public class MinusDTLZ4 extends Problem{
  ...
  */
  public MinusDTLZ4(String solutionType) throws ClassNotFoundException {
    this(12, 3);
  }
  public MinusDTLZ4(HashMap<String, Object> parameters) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public MinusDTLZ4( int numberOfVariables, int numberOfObjectives) {
    numberOfVariables_  = numberOfVariables;
    numberOfObjectives_ = numberOfObjectives;
    problemName_        = "MinusDTLZ4";
