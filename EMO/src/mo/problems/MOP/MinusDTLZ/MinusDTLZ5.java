 ...
 */
public class MinusDTLZ5 extends Problem{
  ...
  */
  public MinusDTLZ5(String solutionType) throws ClassNotFoundException {
    this(12, 3);
  }
  public MinusDTLZ5(HashMap<String, Object> parameters) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public MinusDTLZ5( int numberOfVariables, int numberOfObjectives) {
    numberOfVariables_  = numberOfVariables;
    numberOfObjectives_ = numberOfObjectives;
    problemName_        = "MinusDTLZ5";
