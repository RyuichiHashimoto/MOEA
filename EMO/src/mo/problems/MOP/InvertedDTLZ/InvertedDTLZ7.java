 ...
 */
public class InvertedDTLZ7 extends Problem{
  ...
  */
  public InvertedDTLZ7(String solutionType) throws ClassNotFoundException {
    this(12, 3);
  }
  public InvertedDTLZ7(HashMap<String, Object> parameters) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public InvertedDTLZ7( int numberOfVariables, int numberOfObjectives) {
    numberOfVariables_  = numberOfVariables;
    numberOfObjectives_ = numberOfObjectives;
    problemName_        = "InvertedDTLZ7";
