 ...
 */
public class InvertedDTLZ1 extends Problem {
 /**
  * Creates a default DTLZ1 problem (7 variables and 3 objectives)
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public InvertedDTLZ1(String solutionType) throws ClassNotFoundException {
    this(7, 3);
  } // DTLZ1

	public InvertedDTLZ1(HashMap<String, Object> parameters) {
