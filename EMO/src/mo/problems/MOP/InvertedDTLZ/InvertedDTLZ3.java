 ...
 */
public class InvertedDTLZ3 extends Problem{

 /**
  * Creates a default DTLZ3 problem (12 variables and 3 objectives)
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public InvertedDTLZ3(String solutionType) throws ClassNotFoundException {
    this(12, 3);
  } // DTLZ3
  public InvertedDTLZ3(HashMap<String, Object> parameters) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public InvertedDTLZ3(int numberOfVariables, int numberOfObjectives) {
    numberOfVariables_   = numberOfVariables;
    numberOfObjectives_  = numberOfObjectives;
    problemName_         = "InvertedDTLZ3";
