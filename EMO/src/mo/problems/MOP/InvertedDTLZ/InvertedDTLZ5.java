 ...
 */
public class InvertedDTLZ5 extends Problem{
  ...
  */
  public InvertedDTLZ5(String solutionType) throws ClassNotFoundException {
    this(12, 3);
  }
  public InvertedDTLZ5(HashMap<String, Object> parameters) {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public InvertedDTLZ5( int numberOfVariables, int numberOfObjectives) {
    numberOfVariables_  = numberOfVariables;
    numberOfObjectives_ = numberOfObjectives;
    problemName_        = "InvertedDTLZ5";
